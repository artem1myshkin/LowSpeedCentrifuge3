...
- опрос для экрана наклона/мониторинга: `MS;PX;MO;SO;VX;OL[2];`
...
Актуальное поведение после правки от 2026-05-25:
...
- активные флаги записи в global context: `is_recording` и `is_recording_raw`;
